...
public class SolarSystemScenario
{
    ...
    public void SetupScenario(PhysicsEngine physicsEngine, VisualizationEngine visualizationEngine, PlanetTextureLoader planetTextureLoader)
    {
        ...
        foreach (var entity in _entities)
        {
            ...
            // TODO: Use the following initial colors (generated by Copilot):
            // Mercury: (0.55f, 0.55f, 0.55f) - Grey
            //Venus: (0.85f, 0.74f, 0.55f) - Pale Yellow
            //Earth: (0.27f, 0.50f, 0.70f) - Blue with patches of green and brown (Oceans and landmasses)
            //Mars: (0.69f, 0.19f, 0.13f) - Reddish-brown
            //Jupiter: (0.80f, 0.62f, 0.45f) - Brown and white with bands
            //Saturn: (0.85f, 0.77f, 0.63f) - Pale gold
            //Uranus: (0.56f, 0.77f, 0.89f) - Pale blue
            //Neptune: (0.25f, 0.41f, 0.88f) - Deep blue
            var planetColor = Colors.Gray;

            StandardMaterial material = new StandardMaterial(planetColor, name: $"{entity.Name}Material");
